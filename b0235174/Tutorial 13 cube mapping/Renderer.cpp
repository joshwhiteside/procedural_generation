...
Renderer::Renderer(Window &parent) : OGLRenderer(parent)	{
	camera			= new Camera();
	heightMap		= new HeightMap(TEXTUREDIR"terrain3.raw");
	...
	quad->SetTexture(SOIL_load_OGL_texture(TEXTUREDIR"white.png",
	...
	cubeMap = SOIL_load_OGL_cubemap(
		TEXTUREDIR"right2moon.jpg", TEXTUREDIR"left2moon.jpg",
		TEXTUREDIR"top2moon.jpg", TEXTUREDIR"bot2moon.jpg",
		TEXTUREDIR"front2moon.jpg", TEXTUREDIR"back2moon.jpg", 
		SOIL_LOAD_RGB,
		SOIL_CREATE_NEW_ID,0);
